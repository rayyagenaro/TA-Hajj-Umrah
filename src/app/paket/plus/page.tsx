      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-6">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold">Haji Plus</h1>
          </div>
          <p className="mt-2 text-black dark:text-black">
            Layanan lebih premium dengan waktu tunggu relatif singkat. Pilihan seimbang antara
            kenyamanan dan waktu keberangkatan.
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-2xl border border-black/5 p-5 dark:border-white/10">
            ...
            <p className="text-xl font-semibold">Rp150–250 jt</p>
          </div>
          <div className="rounded-2xl border border-black/5 p-5 dark:border-white/10">
            <p className="text-sm text-black dark:text-black">Perkiraan Waktu</p>
            <p className="text-xl font-semibold">Antrean 1–5 tahun</p>
          </div>
        </div>
        ...
        <div className="mt-6 rounded-2xl border border-black/5 p-6 dark:border-white/10">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5 text-black dark:text-black">
            <li>Hotel lebih dekat</li>
            <li>Pendampingan intensif</li>
            <li>Fasilitas dan konsumsi lebih baik</li>
          </ul>
        </div>
